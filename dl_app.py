...
app.layout = html.Div([
    ...
    html.Div(
        children=[
            dcc.Dropdown(options=state_options, value=default_state, id="dd_state1", clearable=False),
            dcc.Dropdown(options=state_options, value=default_state, id="dd_state2", clearable=False)
    ], className="twelve columns"),
